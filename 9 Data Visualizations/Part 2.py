...
dropdown_options = [
    {'label': 'Yearly Statistics', 'value': 'YS'},
    {'label': 'Recession Period Statistics', 'value': 'RPS'}
]
...
def update_input_container(selected_statistics):
    if selected_statistics == 'YS': 
        return False # This seems to undo the 'disabled'
    else: 
        return True
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(
            figure = px.bar(
                ...
                title = 'Number of Sales by Vehicle Type (during Recesssion)')
            )
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
            figure = px.pie(
                ...
                names = 'Vehicle_Type',
                title = 'Advertising Expenditure by Vehicile Type (Recesssion)')
        )

# Plot 4 Bar chart for the effect of unemployment rate on vehicle type and sales
        # unemployment = recession_data.groupby(['unemployment_rate', 'Vehicle_Type'])['Automoble_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure = px.bar(
                recession_data,
                x = 'unemployment_rate',
                ...
                labels = {'unemployment_rate': 'Unemployment Rate',
                           ...
                           'Vehicle_Type': 'Vehicle Type'},
                color = 'Vehicle_Type',
                title = 'Effect of Unemployment Rate on Sales of Different Vehicles Types (during Recesssion)'
            )
        )
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
    elif (input_year and selected_statistics=='YS') :
...
# Plot 2 Total Monthly Automobile sales using line chart.
        mas = data.groupby('Month')['Automobile_Sales'].sum().reset_index() # .reset_index() makes it dataframe
        Y_chart2 = dcc.Graph(
            figure = px.line(
                mas,
                x = 'Month',
